...
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/cssua.min.js"></script>
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery-3.2.1.min.js"></script>
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery-migrate-3.0.0.min.js"></script>
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery.mobile.custom.min.js"></script>
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/bootstrap.min.js"></script>
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/fancyBox-3.2.10/jquery.fancybox.min.js"></script>
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/select2-4.0.4/js/select2.full.min.js"></script>
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/flickity-2.0.10/flickity.pkgd.min.js"></script>
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/jasny-bootstrap-3.1.3/js/jasny-bootstrap.min.js"></script>
